...
//			CreateFunc: func(ctx context.Context, giftItem models.GiftItem) (*models.GiftItem, error) {
...
func (mock *GiftItemRepositoryInterfaceMock) Create(ctx context.Context, giftItem models.GiftItem) (*models.GiftItem, error) {
