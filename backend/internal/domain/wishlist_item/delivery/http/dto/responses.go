...
type ItemResponse struct {
	...
	IsManuallyReserved    bool    `json:"is_manually_reserved" example:"false"`
	ManualReservedByName  string  `json:"manual_reserved_by_name" example:"Бабушка и дедушка"`
	ManualReservationNote string  `json:"manual_reservation_note" example:"Сказали что купят велосипед"`
