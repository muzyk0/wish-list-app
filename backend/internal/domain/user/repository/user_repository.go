...
func NewUserRepositoryWithEncryption(db *database.DB, encryptionSvc *encryption.Service) UserRepositoryInterface {
	return &UserRepository{
		db:                db,
...
func (r *UserRepository) encryptUserPII(ctx context.Context, user *models.User) error {
...
func (r *UserRepository) decryptUserPII(ctx context.Context, user *models.User) error {
	if !r.encryptionEnabled || r.encryptionSvc == nil {
		return nil
	}
...
func (r *UserRepository) DeleteWithExecutor(ctx context.Context, executor database.Executor, id pgtype.UUID) error {
