...
func makeGiftItem(ownerID pgtype.UUID) *db.GiftItem {
	itemID := pgtype.UUID{}
...
func TestItemService_GetMyItems_Success(t *testing.T) {
	...
	itemRepo := &GiftItemRepositoryInterfaceMock{
		GetByOwnerPaginatedFunc: func(ctx context.Context, oid pgtype.UUID, filters repositories.ItemFilters) (*repositories.PaginatedResult, error) {
	...
	result, err := svc.GetMyItems(context.Background(), ownerStr, repositories.ItemFilters{})
...
func TestItemService_GetMyItems_DefaultFilters(t *testing.T) {
	...
	itemRepo := &GiftItemRepositoryInterfaceMock{
		GetByOwnerPaginatedFunc: func(ctx context.Context, oid pgtype.UUID, filters repositories.ItemFilters) (*repositories.PaginatedResult, error) {
			...
			assert.Equal(t, "created_at", filters.Sort)
			assert.Equal(t, "desc", filters.Order)
			return &repositories.PaginatedResult{Items: []*db.GiftItem{}, TotalCount: 0}, nil
		},
	}
...
func TestItemService_GetMyItems_LimitCap(t *testing.T) {
	...
	svc := newItemService(itemRepo, &WishlistItemRepositoryInterfaceMock{})
	_, err := svc.GetMyItems(context.Background(), ownerStr, repositories.ItemFilters{Limit: 200})
...
func TestItemService_GetMyItems_CustomFilters(t *testing.T) {
	...
	svc := newItemService(itemRepo, &WishlistItemRepositoryInterfaceMock{})
	_, err := svc.GetMyItems(context.Background(), ownerStr, repositories.ItemFilters{
		Limit: 25,
		Page:  3,
		Sort:  "price",
		Order: "asc",
...
func TestItemService_GetMyItems_InvalidUserID(t *testing.T) {
	...
	result, err := svc.GetMyItems(context.Background(), "not-a-uuid", repositories.ItemFilters{})
...
func TestItemService_GetMyItems_TotalPages(t *testing.T) {
	...
	itemRepo := &GiftItemRepositoryInterfaceMock{
		GetByOwnerPaginatedFunc: func(ctx context.Context, oid pgtype.UUID, filters repositories.ItemFilters) (*repositories.PaginatedResult, error) {
			return &repositories.PaginatedResult{
				Items:      []*db.GiftItem{makeGiftItem(ownerID)},
				TotalCount: 25,
			}, nil
		},
	}
...
func TestItemService_CreateItem_Success(t *testing.T) {
	...
	itemRepo := &GiftItemRepositoryInterfaceMock{
		CreateFunc: func(ctx context.Context, gi db.GiftItem) (*db.GiftItem, error) {
...
func TestItemService_UpdateItem_Success_AllFields(t *testing.T) {
	...
	itemRepo := &GiftItemRepositoryInterfaceMock{
		...
		UpdateWithNewSchemaFunc: func(ctx context.Context, gi *db.GiftItem) (*db.GiftItem, error) {
