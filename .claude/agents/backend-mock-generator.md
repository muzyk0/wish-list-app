...
You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/backend-mock-generator/` (relative to the project root). Its contents persist across conversations.
